function(add_par PACKAGE PREFIX)
  if(PACKAGE)
  ...
  add_custom_target(${PACKAGE}.par
    ...
    COMMAND cat ${CMAKE_SOURCE_DIR}/${PREFIX}${PACKAGE}/CMakeLists.txt | grep -v add_par>> ${CMAKE_SOURCE_DIR}/pars/${PACKAGE}/CMakeLists.txt
    COMMAND cp -p ${CMAKE_SOURCE_DIR}/cmake/modules/FindROOT.cmake ${CMAKE_SOURCE_DIR}/pars/${PACKAGE}/
    COMMAND cp -pR ${CMAKE_SOURCE_DIR}/${PREFIX}${PACKAGE}/PROOF-INF ${CMAKE_SOURCE_DIR}/pars/${PACKAGE}/
    COMMAND cp -pR ${CMAKE_SOURCE_DIR}/${PREFIX}${PACKAGE}/*.h ${CMAKE_SOURCE_DIR}/pars/${PACKAGE}/
    COMMAND cp -pR ${CMAKE_SOURCE_DIR}/${PREFIX}${PACKAGE}/*.cxx ${CMAKE_SOURCE_DIR}/pars/${PACKAGE}/
