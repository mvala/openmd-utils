/*
  ...
  gengetopt --file-name=Dump2RootCmd --unamed-opts 
...
#include "Dump2RootCmd.h"

const char *gengetopt_args_info_purpose = "";

const char *gengetopt_args_info_usage = "Usage: Dump2Root [OPTIONS]... [FILES]...";
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:o:n:", long_options, &option_index);
